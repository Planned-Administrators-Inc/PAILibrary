...
(function($) {
	...
	$.fn.poshytip.defaults = {
		...
		className:		'tip-skyblue',	// class for the tips
		bgImageFrameSize:	10,		// size in pixels for the background-image (if set in CSS) frame around the inner content of the tip
		showTimeout:		250,	// timeout before showing the tip (in milliseconds 1000 == 1 second)
		...
		hideAniDuration:	500		// hide animation duration - set to 0 if you don't want hide animation
	};
